...
class TestOpenAIClient:
    ...
    def test_openai_client_initialization(self, mock_settings, mock_openai_class):
        ...
        client = OpenAIClient(api_key="test-openai-key", model="gpt-4", temperature=0.7)
...
class TestGeminiClient:
    ...
    def test_gemini_client_initialization(self, mock_model_class, mock_configure):
        ...
        config = LLMConfig(api_key="test-gemini-key", model="gemini-pro", temperature=0.7)
    ...
    async def test_gemini_generate_with_image(
        self, mock_pil_open, mock_model_class, mock_configure
    ):
...
class TestClaudeClient:
    ...
    def test_claude_client_initialization(self, mock_anthropic_class):
        ...
        config = LLMConfig(
            api_key="test-anthropic-key", model="claude-3-opus-20240229", temperature=0.7
        )
