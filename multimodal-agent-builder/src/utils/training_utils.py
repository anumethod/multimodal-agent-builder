...
class AdaptiveTrainingManager:
    ...
    def __init__(
        ...
        ledger_file: str = "artifacts/ledgers/training_closure_ledger.csv",
    ):
        ...
        Args:
            ...
            ledger_file: Path to ledger artifact file
        """
        ...
        # Initialize ledger
        self.ledger = RecursiveLoopClosureLedger(ledger_file=str(self.ledger_path))
