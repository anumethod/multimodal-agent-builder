...
class GeminiClient(BaseLLMClient):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Safety settings
        self.safety_settings = kwargs.get(
            "safety_settings",
            [
    ...
    async def generate(
        self, messages: List[Message], functions: Optional[List[Dict[str, Any]]] = None, **kwargs
    ) -> LLMResponse:
    ...
    async def generate_with_image(
        ...
        response = await self.model_instance.generate_content_async(
            content, generation_config=generation_config, safety_settings=self.safety_settings
        )
    ...
    async def generate_embeddings(
        self, text: Union[str, List[str]], model: str = "models/text-embedding-004", **kwargs
    ...
    def max_context_length(self) -> int:
        ...
        return self.MODEL_CAPABILITIES.get(self.model, {"max_context": 32768})["max_context"]
